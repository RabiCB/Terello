...
const Page = async() => {
  ...
  return (
    <div className='flex h-[calc(100vh-80px)] gap-4 flex-grow  overflow-y-auto'>
        ...
        <div className='   p-2 min-w-[240px] overflow-hidden '>
        ...
        <div style={{
            scrollbarWidth:"none"
        }} className=' flex-1 overflow-y-scroll p-8 mx-auto flex flex-col gap-4 items-center '>
        ...
        <div className=' w-[240px] p-2 overflow-hidden '>
